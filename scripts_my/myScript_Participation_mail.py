...
#from ..Raduga02 import settings as my_settings
...
os.environ.configure('DJANGO_SETTINGS_MODULE', '../Raduga02.settings')
settings.configure('../Raduga02.settings', DEBUG=True)
